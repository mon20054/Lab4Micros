...
config_IO:
    ...
    banksel TRISB
    bcf TRISB, 0 ; ((PORTB) and 07Fh), 0 como salida
    bcf TRISB, 1 ; ((PORTB) and 07Fh), 1 como salida
    bcf TRISB, 2 ; ((PORTB) and 07Fh), 2 como salida
    bcf TRISB, 3 ; ((PORTB) and 07Fh), 3 como salida
    bsf TRISB, 4 ; ((PORTB) and 07Fh), 4 como entrada
    bsf TRISB, 5 ; ((PORTB) and 07Fh), 5 como entrada
    banksel WPUB ; Banco para pullups puerto B
    bsf WPUB, 4 ; ((PORTB) and 07Fh), 0 con Pullup interno
    bsf WPUB, 5 ; ((PORTB) and 07Fh), 1 con Pullup interno
    banksel TRISA
 ...
 config_int:
    ...
    bsf IOCB, 5 ; Interrupcion en ((PORTB) and 07Fh), 5
